...
area = st.sidebar.number_input("Área total", value=0)
num_quartos = st.sidebar.number_input("Número de Quartos", value=0)
num_banheiros = st.sidebar.number_input("Número de Banheiros", value=0)
vagas_garagem = st.sidebar.number_input("Vagas de Garagem", value=0)
num_andares = st.sidebar.number_input("Número de Andares", value=0)
...
estado = st.sidebar.selectbox("Estado",("SP", "RJ", "MG", "RS"))

cidade = st.sidebar.selectbox("Cidade", ("São Paulo", "Rio de Janeiro", "Belo Horizonte", "Campinas", "Porto Alegre"))

valor_condominio = st.sidebar.number_input("Valor do Condomínio", value=0)
valor_iptu = st.sidebar.number_input("Valor do IPTU", value=0)
valor_seguro_incendio = st.sidebar.number_input("Valor do Seguro Incêndio", value=0)
