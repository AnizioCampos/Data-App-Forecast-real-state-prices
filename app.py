...
area = st.sidebar.number_input("Área total", value=None)
num_quartos = st.sidebar.number_input("Número de Quartos", value=None)
num_banheiros = st.sidebar.number_input("Número de Banheiros", value=None)
vagas_garagem = st.sidebar.number_input("Vagas de Garagem", value=None)
num_andares = st.sidebar.number_input("Número de Andares", value=None)
...
estado = st.sidebar.selectbox("Estado",("SP", "RJ", "MG", "SP", "RS"))
